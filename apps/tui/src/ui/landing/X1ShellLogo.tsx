...
export function X1ShellLogo(props: { viewportColumns: number; theme: TuiTheme }) {
  const showFullLogo = props.viewportColumns >= FULL_LOGO_WIDTH + 8;
  const lines = showFullLogo ? FULL_LOGO : [COMPACT_LOGO];
  const width = showFullLogo ? FULL_LOGO_WIDTH : COMPACT_LOGO.length;
